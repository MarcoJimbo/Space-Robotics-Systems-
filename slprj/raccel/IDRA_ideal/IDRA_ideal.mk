...
MODEL                   = IDRA_ideal
MODULES                 = IDRA_ideal.c IDRA_ideal_capi.c IDRA_ideal_data.c IDRA_ideal_tgtconn.c rt_nonfinite.c raccel_main.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c slsa_sim_common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT                 = IDRA_ideal.exe
MAKEFILE                = IDRA_ideal.mk
...
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = IDRA_ideal_ref.rsp
COMPILER_COMMAND_FILE     = IDRA_ideal_comp.rsp
