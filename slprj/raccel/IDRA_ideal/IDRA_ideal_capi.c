...
, & rtP . A_v [ 0 ] , & rtP . DELTA , & rtP . K , & rtP . Kd [ 0 ] , & rtP .
Ki [ 0 ] , & rtP . Kp [ 0 ] , & rtP . M_m [ 0 ] , & rtP . Ra [ 0 ] , & rtP .
T_moto_A , & rtP . T_s , & rtP . gear_ratio [ 0 ] , & rtP . ke [ 0 ] , & rtP
. km [ 0 ] , & rtP . q0_A [ 0 ] , & rtP . qd0_A [ 0 ] , & rtP . qdd0_A [ 0 ]
, & rtP . t_LPF , & rtP . t_const , & rtP . t_fade , } ; static int32_T *
