###########################################################################
## Makefile generated for component 'IDRA_mismodeled_A'. 
## 
## Makefile     : IDRA_mismodeled_A.mk
## Generated on : Sun Jan 04 18:18:12 2026
## Final product: ./IDRA_mismodeled_A.exe
...
PRODUCT_NAME              = IDRA_mismodeled_A
MAKEFILE                  = IDRA_mismodeled_A.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2024b
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2024b/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/dgall/ONEDRI~1.IT/DOCUME~1/GitHub/SPACE-~1/SPACE-~1
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 1
TGT_FCN_LIB               = ISO_C
...
COMPILER_COMMAND_FILE     = IDRA_mismodeled_A_comp.rsp
CMD_FILE                  = IDRA_mismodeled_A.rsp
...
DEFINES_STANDARD = -DMODEL=IDRA_mismodeled_A -DNUMST=4 -DNCSTATES=10 -DHAVESTDIO
...
SRCS = $(START_DIR)/slprj/raccel/IDRA_mismodeled_A/IDRA_mismodeled_A.c $(START_DIR)/slprj/raccel/IDRA_mismodeled_A/IDRA_mismodeled_A_capi.c $(START_DIR)/slprj/raccel/IDRA_mismodeled_A/IDRA_mismodeled_A_data.c $(START_DIR)/slprj/raccel/IDRA_mismodeled_A/IDRA_mismodeled_A_tgtconn.c $(START_DIR)/slprj/raccel/IDRA_mismodeled_A/rt_nonfinite.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_main.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_sup.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_mat.c $(MATLAB_ROOT)/simulink/include/simulink_solver_api.c $(MATLAB_ROOT)/rtw/c/src/rapid/raccel_utils.c $(MATLAB_ROOT)/rtw/c/src/rapid/slsa_sim_common_utils.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_svr.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/updown.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_work.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/rtiostream_interface.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/rtiostreamtcpip/rtiostream_tcpip.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils/rtiostream_utils.c
...
OBJS = IDRA_mismodeled_A.obj IDRA_mismodeled_A_capi.obj IDRA_mismodeled_A_data.obj IDRA_mismodeled_A_tgtconn.obj rt_nonfinite.obj raccel_main.obj raccel_sup.obj raccel_mat.obj simulink_solver_api.obj raccel_utils.obj slsa_sim_common_utils.obj ext_svr.obj updown.obj ext_work.obj rtiostream_interface.obj rtiostream_tcpip.obj rtiostream_utils.obj
...
%.obj : $(START_DIR)/slprj/raccel/IDRA_mismodeled_A/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/IDRA_mismodeled_A/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/IDRA_mismodeled_A/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/IDRA_mismodeled_A/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/IDRA_mismodeled_A/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
IDRA_mismodeled_A.obj : $(START_DIR)/slprj/raccel/IDRA_mismodeled_A/IDRA_mismodeled_A.c
	$(CC) $(CFLAGS) -o "$@" "$<"


IDRA_mismodeled_A_capi.obj : $(START_DIR)/slprj/raccel/IDRA_mismodeled_A/IDRA_mismodeled_A_capi.c
	$(CC) $(CFLAGS) -o "$@" "$<"


IDRA_mismodeled_A_data.obj : $(START_DIR)/slprj/raccel/IDRA_mismodeled_A/IDRA_mismodeled_A_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


IDRA_mismodeled_A_tgtconn.obj : $(START_DIR)/slprj/raccel/IDRA_mismodeled_A/IDRA_mismodeled_A_tgtconn.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.obj : $(START_DIR)/slprj/raccel/IDRA_mismodeled_A/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
