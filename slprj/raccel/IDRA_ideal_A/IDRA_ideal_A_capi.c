...
#endif
#endif
static const rtwCAPI_Signals rtBlockSignals [ ] = { { 0 , 1 , TARGET_STRING ( "IDRA_ideal_A/MATLAB Function" ) , TARGET_STRING ( "qdd_true" ) , 0 , 0 , 0 , 0 , 0 } , { 1 , 4 , TARGET_STRING ( "IDRA_ideal_A/MATLAB Function3" ) , TARGET_STRING ( "tau" ) , 0 , 0 , 0 , 0 , 1 } , { 2 , 5 , TARGET_STRING ( "IDRA_ideal_A/MATLAB Function4" ) , TARGET_STRING ( "" ) , 0 , 0 , 1 , 0 , 1 } , { 3 , 5 , TARGET_STRING ( "IDRA_ideal_A/MATLAB Function4" ) , TARGET_STRING ( "" ) , 1 , 0 , 2 , 0 , 1 } , { 4 , 5 , TARGET_STRING ( "IDRA_ideal_A/MATLAB Function4" ) , TARGET_STRING ( "" ) , 2 , 0 , 1 , 0 , 1 } , { 5 , 5 , TARGET_STRING ( "IDRA_ideal_A/MATLAB Function4" ) , TARGET_STRING ( "" ) , 3 , 0 , 0 , 0 , 1 } , { 6 , 6 , TARGET_STRING ( "IDRA_ideal_A/MATLAB Function5" ) , TARGET_STRING ( "qd_meas" ) , 0 , 0 , 0 , 0 , 2 } , { 7 , 7 , TARGET_STRING ( "IDRA_ideal_A/MATLAB Function6" ) , TARGET_STRING ( "" ) , 0 , 0 , 0 , 0 , 2 } , { 8 , 8 , TARGET_STRING ( "IDRA_ideal_A/MATLAB Function7" ) , TARGET_STRING ( "" ) , 0 , 0 , 3 , 0 , 2 } , { 9 , 8 , TARGET_STRING ( "IDRA_ideal_A/MATLAB Function7" ) , TARGET_STRING ( "" ) , 1 , 0 , 0 , 0 , 2 } , { 10 , 8 , TARGET_STRING ( "IDRA_ideal_A/MATLAB Function7" ) , TARGET_STRING ( "" ) , 2 , 0 , 0 , 0 , 2 } , { 11 , 9 , TARGET_STRING ( "IDRA_ideal_A/MATLAB Function8" ) , TARGET_STRING ( "tau_m" ) , 0 , 0 , 0 , 0 , 2 } , { 12 , 9 , TARGET_STRING ( "IDRA_ideal_A/MATLAB Function8" ) , TARGET_STRING ( "" ) , 1 , 0 , 0 , 0 , 2 } , { 13 , 9 , TARGET_STRING ( "IDRA_ideal_A/MATLAB Function8" ) , TARGET_STRING ( "" ) , 2 , 0 , 0 , 0 , 2 } , { 14 , 9 , TARGET_STRING ( "IDRA_ideal_A/MATLAB Function8" ) , TARGET_STRING ( "" ) , 3 , 0 , 0 , 0 , 2 } , { 15 , 0 , TARGET_STRING ( "IDRA_ideal_A/Clock" ) , TARGET_STRING ( "" ) , 0 , 0 , 4 , 0 , 0 } , { 16 , 0 , TARGET_STRING ( "IDRA_ideal_A/Clock1" ) , TARGET_STRING ( "" ) , 0 , 0 , 4 , 0 , 0 } , { 17 , 0 , TARGET_STRING ( "IDRA_ideal_A/From File" ) , TARGET_STRING ( "" ) , 0 , 0 , 5 , 0 , 3 } , { 18 , 0 , TARGET_STRING ( "IDRA_ideal_A/From File1" ) , TARGET_STRING ( "" ) , 0 , 0 , 5 , 0 , 3 } , { 19 , 0 , TARGET_STRING ( "IDRA_ideal_A/From File2" ) , TARGET_STRING ( "" ) , 0 , 0 , 5 , 0 , 3 } , { 20 , 0 , TARGET_STRING ( "IDRA_ideal_A/Gain2" ) , TARGET_STRING ( "ki*err_i" ) , 0 , 0 , 5 , 0 , 2 } , { 21 , 0 , TARGET_STRING ( "IDRA_ideal_A/integrate qdd" ) , TARGET_STRING ( "qd_true" ) , 0 , 0 , 0 , 0 , 0 } , { 22 , 0 , TARGET_STRING ( "IDRA_ideal_A/Add" ) , TARGET_STRING ( "tau_p" ) , 0 , 0 , 5 , 0 , 3 } , { 23 , 0 , TARGET_STRING ( "IDRA_ideal_A/Add1" ) , TARGET_STRING ( "" ) , 0 , 0 , 0 , 0 , 0 } , { 24 , 0 , TARGET_STRING ( "IDRA_ideal_A/Subtract1" ) , TARGET_STRING ( "" ) , 0 , 0 , 0 , 0 , 3 } , { 0 , 0 , ( NULL ) , ( NULL ) , 0 , 0 , 0 , 0 , 0 } } ; static const rtwCAPI_BlockParameters rtBlockParameters [ ] = { { 25 , TARGET_STRING ( "IDRA_ideal_A/integrate err" ) , TARGET_STRING ( "gainval" ) , 0 , 4 , 0 } , { 26 , TARGET_STRING ( "IDRA_ideal_A/integrate err" ) , TARGET_STRING ( "InitialCondition" ) , 0 , 4 , 0 } , { 0 , ( NULL ) , ( NULL ) , 0 , 0 , 0 } } ; static int_T rt_LoggedStateIdxList [ ] = { - 1 } ; static const rtwCAPI_Signals rtRootInputs [ ] = { { 0 , 0 , ( NULL ) , ( NULL ) , 0 , 0 , 0 , 0 , 0 } } ; static const rtwCAPI_Signals rtRootOutputs [ ] = { { 0 , 0 , ( NULL ) , ( NULL ) , 0 , 0 , 0 , 0 , 0 } } ; static const rtwCAPI_ModelParameters rtModelParameters [ ] = { { 27 , TARGET_STRING ( "A_c" ) , 0 , 5 , 0 } , { 28 , TARGET_STRING ( "A_v" ) , 0 , 1 , 0 } , { 29 , TARGET_STRING ( "DELTA" ) , 0 , 4 , 0 } , { 30 , TARGET_STRING ( "K" ) , 0 , 4 , 0 } , { 31 , TARGET_STRING ( "Kd" ) , 0 , 1 , 0 } , { 32 , TARGET_STRING ( "Ki" ) , 0 , 1 , 0 } , { 33 , TARGET_STRING ( "Kp" ) , 0 , 1 , 0 } , { 34 , TARGET_STRING ( "M_m" ) , 0 , 1 , 0 } , { 35 , TARGET_STRING ( "Ra" ) , 0 , 5 , 0 } , { 36 , TARGET_STRING ( "T_moto_A" ) , 0 , 4 , 0 } , { 37 , TARGET_STRING ( "T_s" ) , 0 , 4 , 0 } , { 38 , TARGET_STRING ( "gear_ratio" ) , 0 , 5 , 0 } , { 39 , TARGET_STRING ( "ke" ) , 0 , 5 , 0 } , { 40 , TARGET_STRING ( "km" ) , 0 , 5 , 0 } , { 41 , TARGET_STRING ( "q0_A" ) , 0 , 5 , 0 } , { 42 , TARGET_STRING ( "qd0_A" ) , 0 , 5 , 0 } , { 43 , TARGET_STRING ( "qdd0_A" ) , 0 , 5 , 0 } , { 44 , TARGET_STRING ( "t_LPF" ) , 0 , 4 , 0 } , { 45 , TARGET_STRING ( "t_const" ) , 0 , 4 , 0 } , { 46 , TARGET_STRING ( "t_fade" ) , 0 , 4 , 0 } , { 0 , ( NULL ) , 0 , 0 , 0 } } ;
...
rtB . jz4m5cmwj5 , & rtB . dv24ac1zbl , & rtB . eueq0mhitg [ 0 ] , & rtB .
e43yyd10tj [ 0 ] , & rtB . cbvmdjjaw3 [ 0 ] , & rtB . hdz5un0qo2 [ 0 ] , &
rtB . gsbfze2nok [ 0 ] , & rtB . ihd3wyvjoy [ 0 ] , & rtB . g5xwnazqpz [ 0 ]
, & rtB . khirpgqnch [ 0 ] , & rtP . integrateerr_gainval , & rtP .
