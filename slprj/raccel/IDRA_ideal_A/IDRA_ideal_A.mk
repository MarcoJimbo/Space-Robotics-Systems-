...
MODEL                   = IDRA_ideal_A
MODULES                 = IDRA_ideal_A.c IDRA_ideal_A_capi.c IDRA_ideal_A_data.c IDRA_ideal_A_tgtconn.c rt_nonfinite.c raccel_main.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c slsa_sim_common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
