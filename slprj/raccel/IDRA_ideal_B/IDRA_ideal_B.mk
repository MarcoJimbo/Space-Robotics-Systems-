###########################################################################
## Makefile generated for component 'IDRA_ideal_B'. 
## 
## Makefile     : IDRA_ideal_B.mk
## Generated on : Sun Jan 04 17:00:03 2026
## Final product: ./IDRA_ideal_B.exe
...
COMPILER_COMMAND_FILE     = IDRA_ideal_B_comp.rsp
CMD_FILE                  = IDRA_ideal_B.rsp
...
DEFINES_STANDARD = -DMODEL=IDRA_ideal_B -DNUMST=4 -DNCSTATES=10 -DHAVESTDIO
...
SRCS = $(START_DIR)/slprj/raccel/IDRA_ideal_B/IDRA_ideal_B.c $(START_DIR)/slprj/raccel/IDRA_ideal_B/IDRA_ideal_B_capi.c $(START_DIR)/slprj/raccel/IDRA_ideal_B/IDRA_ideal_B_data.c $(START_DIR)/slprj/raccel/IDRA_ideal_B/IDRA_ideal_B_tgtconn.c $(START_DIR)/slprj/raccel/IDRA_ideal_B/rt_nonfinite.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_main.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_sup.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_mat.c $(MATLAB_ROOT)/simulink/include/simulink_solver_api.c $(MATLAB_ROOT)/rtw/c/src/rapid/raccel_utils.c $(MATLAB_ROOT)/rtw/c/src/rapid/slsa_sim_common_utils.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_svr.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/updown.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_work.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/rtiostream_interface.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/rtiostreamtcpip/rtiostream_tcpip.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils/rtiostream_utils.c
...
OBJS = IDRA_ideal_B.obj IDRA_ideal_B_capi.obj IDRA_ideal_B_data.obj IDRA_ideal_B_tgtconn.obj rt_nonfinite.obj raccel_main.obj raccel_sup.obj raccel_mat.obj simulink_solver_api.obj raccel_utils.obj slsa_sim_common_utils.obj ext_svr.obj updown.obj ext_work.obj rtiostream_interface.obj rtiostream_tcpip.obj rtiostream_utils.obj
...
%.obj : $(START_DIR)/slprj/raccel/IDRA_ideal_B/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/IDRA_ideal_B/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/IDRA_ideal_B/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/IDRA_ideal_B/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/IDRA_ideal_B/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
IDRA_ideal_B.obj : $(START_DIR)/slprj/raccel/IDRA_ideal_B/IDRA_ideal_B.c
	$(CC) $(CFLAGS) -o "$@" "$<"


IDRA_ideal_B_capi.obj : $(START_DIR)/slprj/raccel/IDRA_ideal_B/IDRA_ideal_B_capi.c
	$(CC) $(CFLAGS) -o "$@" "$<"


IDRA_ideal_B_data.obj : $(START_DIR)/slprj/raccel/IDRA_ideal_B/IDRA_ideal_B_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


IDRA_ideal_B_tgtconn.obj : $(START_DIR)/slprj/raccel/IDRA_ideal_B/IDRA_ideal_B_tgtconn.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.obj : $(START_DIR)/slprj/raccel/IDRA_ideal_B/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
